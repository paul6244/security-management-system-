...
<html>
<head>
<title>Staff Registration with Fingerprint</title>
...
<div class="navbar">
    Staff Registration with Fingerprint | Welcome <%= session.getAttribute("username") %>
</div>
...
<h2>Register New Staff Member with Fingerprint</h2>

<!-- Status Messages -->
<div id="statusMessage" class="status-message"></div>

<form id="staffRegistrationForm" action="StaffRegistrationWithFingerprint" method="post">
...
<div class="form-group full-width fingerprint-section">
    ...
    <div class="fingerprint-container">
        ...
        <div class="fingerprint-option">
            <label>
                <input type="radio" name="fingerprintOption" value="skip">
                <span>Skip Fingerprint Registration (Can register later)</span>
            </label>
        </div>
...
function validateRegistrationForm() {
    ...
    if (fingerprintOption === 'register' && !fingerprintRegistered) {
        showStatus('Please register fingerprint first or select "Skip Fingerprint Registration"', 'error');
        return false;
    }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if(form) {
        form.addEventListener('submit', function(e) {
            ...
            // If fingerprint is registered, add fingerprint data to form
            if (fingerprintRegistered && fingerprintData) {
                const hiddenInput = document.createElement('input');
                hiddenInput.type = 'hidden';
                hiddenInput.name = 'fingerprintData';
                hiddenInput.value = fingerprintData;
...
// Handle fingerprint option change
document.addEventListener('DOMContentLoaded', function() {
    const fingerprintOptions = document.querySelectorAll('input[name="fingerprintOption"]');
