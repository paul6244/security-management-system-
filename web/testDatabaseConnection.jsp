    ...
    try {
        ...
        try {
            ...
            if (tables.next()) {
                ...
                ResultSet countRs = userStmt.executeQuery("SELECT COUNT(*) FROM users");
                if (countRs.next()) {
            ...
            if (tables.next()) {
                ...
                ResultSet countRs = branchStmt.executeQuery("SELECT COUNT(*) FROM branches");
                if (countRs.next()) {
                ...
                for (String branchName : branchNames) {
                    createStmt.executeUpdate("INSERT INTO branches (name) VALUES ('" + branchName + "')");
                }
